...
// 206
console.log(lab1.questionOne([100, 200, 300])); 
// 140,000
...
// 5
console.log(lab1.questionThree("Lorem Ipsum"));
// 4
console.log(lab1.questionThree("PEEPEE"));
// 4
console.log(lab1.questionThree("poOpOo"));
// 4
console.log(lab1.questionThree("aaa1EEE2iii3OOO4uuu5!@#$%^&*()"));
// 15
